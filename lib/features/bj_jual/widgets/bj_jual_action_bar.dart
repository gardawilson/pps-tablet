...
class BJJualActionBar extends StatefulWidget {
  ...
  @override
  State<BJJualActionBar> createState() => _BJJualActionBarState();
}

class _BJJualActionBarState extends State<BJJualActionBar> {
  ...
  Widget build(BuildContext context) {
    ...
    // contoh: 'bj_jual:create' atau 'label_bj_jual:create'
              ...
              return Row(
                children: [
                  ...
                  Tooltip(
                    message: canCreate
                        ? 'Buat BJ Jual Baru'
                        : 'Anda tidak memiliki izin untuk membuat BJ Jual',
                    waitDuration: const Duration(milliseconds: 400),
                    child: FilledButton.icon(
                      onPressed: canCreate ? widget.onAddPressed : null,
                      icon: const Icon(Icons.add),
                      label: const Text('Tambah BJ Jual'),
                          ...
                          Expanded(
                            child: TextField(
                              ...
                              decoration: InputDecoration(
                                hintText: 'Cari NoBJJual (contains)…',
                                hintStyle:
