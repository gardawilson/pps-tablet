// lib/features/shared/bongkar_susun/widgets/bongkar_susun_lookup_label_partial_dialog.dart
...
class BongkarSusunLookupLabelPartialDialog extends StatefulWidget {
  final String noBongkarSusun;
  final String selectedMode;

  const BongkarSusunLookupLabelPartialDialog({
    super.key,
  ...
  @override
  State<BongkarSusunLookupLabelPartialDialog> createState() =>
      _BongkarSusunLookupLabelPartialDialogState();
}

class _BongkarSusunLookupLabelPartialDialogState
    extends State<BongkarSusunLookupLabelPartialDialog> {
  int? _selectedIndex;
  double? _editedWeight;
  int? _editedPcs; // ✅ NEW untuk FW & BJ
                  ...
                  child: Row(
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          hasPcsColumn
                              ? 'Pilih SATU item, lalu klik Edit untuk mengubah PCS & berat'
                      ...
                      if (_selectedIndex != null)
                        Container(
                          ...
                          child: Text(
                              ...
                              final hasEdit = (_editedWeight != null &&
                                  _editedWeight != _beratOf(item)) ||
                                  (_editedPcs != null &&
                                      _editedPcs != _pcsOf(item));
                              return '1 item${hasEdit ? ' • Diubah' : ''}';
                            }(),
                            style: TextStyle(
  ...
  static String _labelCodeOf(dynamic item) {
    ...
    if (item is BarangJadiItem) {
      return (item.noBJPartial ?? '').trim().isNotEmpty
          ? item.noBJPartial!
          : item.noBJ ?? '-';
    }
    return '-';
