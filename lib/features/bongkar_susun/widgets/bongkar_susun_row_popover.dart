...
class BongkarSusunRowPopover extends StatelessWidget {
  final BongkarSusun row;
  final VoidCallback onClose;

  // Actions
  final VoidCallback? onInput; // opsional
  ...
  Future<void> _copyOnly(BuildContext context) async {
    await Clipboard.setData(ClipboardData(text: row.noBongkarSusun));
    final m = ScaffoldMessenger.maybeOf(context);
    m?.hideCurrentSnackBar();
    m?.showSnackBar(
      SnackBar(
        content: Text('NoBongkarSusun "${row.noBongkarSusun}" disalin'),
