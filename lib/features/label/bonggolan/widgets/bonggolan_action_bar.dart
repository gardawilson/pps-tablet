...
class BonggolanActionBar extends StatefulWidget {
  ...
  @override
  State<BonggolanActionBar> createState() => _BonggolanActionBarState();
}

class _BonggolanActionBarState extends State<BonggolanActionBar> {
  ...
  Widget build(BuildContext context) {
    ...
    final canCreate = perm.can('label_bonggolan:create');
                          ...
                          Expanded(
                            child: TextField(
                              ...
                              decoration: InputDecoration(
                                hintText: 'Cari Nomor Bonggolan / Jenis',
                                hintStyle: TextStyle(
