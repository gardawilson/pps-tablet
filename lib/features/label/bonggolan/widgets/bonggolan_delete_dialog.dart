...
class BonggolanDeleteDialog extends StatefulWidget {
  ...
  @override
  State<BonggolanDeleteDialog> createState() => _BonggolanDeleteDialogState();
}

class _BonggolanDeleteDialogState extends State<BonggolanDeleteDialog> {
  bool _agree = false;
