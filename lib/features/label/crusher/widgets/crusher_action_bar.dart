...
class CrusherActionBar extends StatefulWidget {
  ...
  @override
  State<CrusherActionBar> createState() => _CrusherActionBarState();
}

class _CrusherActionBarState extends State<CrusherActionBar> {
                          ...
                          Expanded(
                            child: TextField(
                              ...
                              decoration: InputDecoration(
                                hintText: 'Cari Nomor Crusher / Jenis',
                                hintStyle: TextStyle(
