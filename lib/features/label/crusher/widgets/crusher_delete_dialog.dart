...
class CrusherDeleteDialog extends StatefulWidget {
  ...
  @override
  State<CrusherDeleteDialog> createState() => _CrusherDeleteDialogState();
}

class _CrusherDeleteDialogState extends State<CrusherDeleteDialog> {
  bool _agree = false;
        ...
        children: [
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                _InfoRow(label: 'No. Crusher', value: widget.header.noCrusher),
