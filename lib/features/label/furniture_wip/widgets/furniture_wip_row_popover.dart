...
class FurnitureWipRowPopover extends StatefulWidget {
  ...
  @override
  State<FurnitureWipRowPopover> createState() => _FurnitureWipRowPopoverState();
}

class _FurnitureWipRowPopoverState extends State<FurnitureWipRowPopover> {
  ...
  Future<void> _copyOnly() async {
    await Clipboard.setData(ClipboardData(text: widget.header.noFurnitureWip));
    if (!mounted) return;
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            (widget.header.namaFurnitureWip ?? '')
                                    .trim()
                                    .isEmpty
                                ? 'Furniture WIP'
                                : widget.header.namaFurnitureWip!.trim(),
                            style: const TextStyle(
                              fontSize: 12,
