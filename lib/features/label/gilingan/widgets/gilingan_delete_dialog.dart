...
class GilinganDeleteDialog extends StatefulWidget {
  ...
  @override
  State<GilinganDeleteDialog> createState() => _GilinganDeleteDialogState();
}

class _GilinganDeleteDialogState extends State<GilinganDeleteDialog> {
  bool _agree = false;
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                _InfoRow(
                  label: 'No. Gilingan',
                  value: widget.header.noGilingan,
                ),
