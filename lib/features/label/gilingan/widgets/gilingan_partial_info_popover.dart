...
Future<void> showGilinganPartialInfoPopover({
  ...
  await popover.show(
    ...
    child: ChangeNotifierProvider.value(
      value: vm,
      child: _GilinganPartialInfoCard(
  ...
  await vm.loadPartialInfo(noGilingan: noGilingan);
}

class _GilinganPartialInfoCard extends StatefulWidget {
  final String noGilingan;
  final VoidCallback onClose;

  const _GilinganPartialInfoCard({
    required this.noGilingan,
    required this.onClose,
  });

  @override
  State<_GilinganPartialInfoCard> createState() =>
      _GilinganPartialInfoCardState();
}

class _GilinganPartialInfoCardState extends State<_GilinganPartialInfoCard> {
  late GilinganViewModel vm;

  @override
  void initState() {
    super.initState();
    vm = context.read<GilinganViewModel>();
  }
    ...
    return ConstrainedBox(
      ...
      child: Material(
        ...
        child: Padding(
          padding: const EdgeInsets.all(16),
          child: Text(
            'Tidak ada partial untuk Gilingan ini',
