// lib/view/widgets/mixer_action_bar.dart
...
class MixerActionBar extends StatefulWidget {
  final TextEditingController controller;
  final ValueChanged<String> onSearchChanged;
  final VoidCallback onClear;
  final VoidCallback onAddPressed;

  const MixerActionBar({
    super.key,
  ...
  @override
  State<MixerActionBar> createState() => _MixerActionBarState();
}

class _MixerActionBarState extends State<MixerActionBar> {
        ...
        child: Focus(
          ...
          child: LayoutBuilder(
            builder: (context, c) {
              ...
              return Row(
                children: [
                  // Create Mixer Label button (permission-aware)
                  Tooltip(
                    message: canCreate
                        ? 'Create new Mixer label'
                        : 'You do not have permission to create Mixer labels',
                  ...
                  // External reset button for narrow layout
                  if (isTight)
