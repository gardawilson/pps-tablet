...
class MixerDeleteDialog extends StatefulWidget {
  ...
  @override
  State<MixerDeleteDialog> createState() => _MixerDeleteDialogState();
}

class _MixerDeleteDialogState extends State<MixerDeleteDialog> {
  bool _agree = false;
        ...
        children: [
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                _InfoRow(label: 'NoBroker', value: widget.header.noMixer),
                const SizedBox(height: 6),
                _InfoRow(label: 'Jenis', value: widget.header.namaMixer),
