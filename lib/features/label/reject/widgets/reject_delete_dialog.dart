...
class RejectDeleteDialog extends StatefulWidget {
  ...
  @override
  State<RejectDeleteDialog> createState() => _RejectDeleteDialogState();
}

class _RejectDeleteDialogState extends State<RejectDeleteDialog> {
  bool _agree = false;
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                _InfoRow(
                  label: 'No. Reject',
                  value: widget.header.noReject,
                ),
                const SizedBox(height: 6),
                _InfoRow(
                  label: 'ID Reject',
                  value: widget.header.idReject.toString(),
                ),
                const SizedBox(height: 6),
