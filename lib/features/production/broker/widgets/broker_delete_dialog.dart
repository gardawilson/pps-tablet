...
import 'package:pps_tablet/features/production/broker/model/broker_production_model.dart';

class BrokerProductionDeleteDialog extends StatefulWidget {
  final BrokerProduction header;
  /// Parent yang menutup dialog; komponen ini tidak memanggil Navigator.pop.
  final Future<void> Function() onConfirm;

  const BrokerProductionDeleteDialog({
    super.key,
  ...
  @override
  State<BrokerProductionDeleteDialog> createState() => _BrokerProductionDeleteDialogState();
}

class _BrokerProductionDeleteDialogState extends State<BrokerProductionDeleteDialog> {
  bool _agree = false;
        ...
        children: [
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                _InfoRow(label: 'NoBroker', value: widget.header.noProduksi),
