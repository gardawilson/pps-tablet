...
/// Header section panel kanan (riwayat produksi) pada BrokerProductionMesinScreen.
/// Menampilkan judul, chip "Semua", dan chips per-mesin untuk filter.
class BrokerRiwayatSectionHeader extends StatelessWidget {
  const BrokerRiwayatSectionHeader({
    super.key,
