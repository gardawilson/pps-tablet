...
class CrusherProductionDeleteDialog extends StatefulWidget {
  ...
  @override
  State<CrusherProductionDeleteDialog> createState() => _CrusherProductionDeleteDialogState();
}

class _CrusherProductionDeleteDialogState extends State<CrusherProductionDeleteDialog> {
  bool _agree = false;
        ...
        children: [
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                _InfoRow(label: 'NoBroker', value: widget.header.noCrusherProduksi),
                const SizedBox(height: 6),
                _InfoRow(label: 'Mesin', value: widget.header.namaMesin),
                  const SizedBox(height: 6),
                _InfoRow(label: 'Tanggal', value: formatDateToFullId(widget.header.tanggal!)),
              ],
            ),
          ),
