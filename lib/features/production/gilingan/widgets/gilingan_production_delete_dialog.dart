// lib/features/shared/gilingan_production/widgets/gilingan_production_delete_dialog.dart
...
class GilinganProductionDeleteDialog extends StatefulWidget {
  ...
  @override
  State<GilinganProductionDeleteDialog> createState() =>
      _GilinganProductionDeleteDialogState();
}

class _GilinganProductionDeleteDialogState
    extends State<GilinganProductionDeleteDialog> {
  bool _agree = false;
      ...
      content: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                _InfoRow(
                  label: 'Tanggal',
                  value: widget.header.tglProduksi == null
                      ? '-'
                      : formatDateToFullId(widget.header.tglProduksi!),
                ),
              ],
            ),
          ),
          ...
          CheckboxListTile(
            ...
            title: Text(
              'Saya mengerti dan ingin menghapus produksi gilingan ini.',
