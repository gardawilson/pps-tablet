// lib/features/production/gilingan/widgets/gilingan_sak_picker_dialog.dart
// Thin wrapper around ProductionSakPickerDialog for GilinganProductionInputViewModel.
...
class GilinganSakPickerDialog extends StatelessWidget {
  final String noProduksi;
  final bool isPartialMode;

  const GilinganSakPickerDialog({
    super.key,
