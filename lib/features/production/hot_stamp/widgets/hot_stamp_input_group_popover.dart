// lib/features/production/hot_stamping/widgets/hot_stamping_input_group_popover.dart
...
bool _hasPartialTempForLabel(
  ...
  final hasFwipPart = b.furnitureWipItems
          ...
          child: SizedBox(
            ...
            child: Column(
              ...
              children: [
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Builder(
                          builder: (_) {
                            final vm = context
                                .read<HotStampingProductionInputViewModel>();
                ...
                // =======================================================
                Flexible(
                  child: Consumer<HotStampingProductionInputViewModel>(
                ...
                if (widget.summaryBuilder != null)
                  Consumer<HotStampingProductionInputViewModel>(
                    builder: (context, vm, _) {
                              ...
                              if (flexes.isEmpty) {
                                ...
                                for (int i = 0; i < flexes.length; i++) {
                                  if (i == 0) {
                                    ...
                                    // Kolom Berat (terakhir sebelum action)
                                    summaryColumns.add(
                                      Expanded(
                                        flex: flexes[i],
                                        child: Padding(
...
class _GroupTooltipAnchorTileState extends State<GroupTooltipAnchorTile> {
  ...
  Future<void> _handleDeleteAllTemp(
      HotStampingProductionInputViewModel vm) async {
