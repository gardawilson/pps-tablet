// lib/features/production/hot_stamping/widgets/hot_stamping_lookup_label_dialog.dart
...
class HotStampingLookupLabelDialog extends StatefulWidget {
  final String noProduksi;
  final String selectedMode;
  final Set<int>? preDisabledIndices;

  const HotStampingLookupLabelDialog({
    super.key,
  ...
  @override
  State<HotStampingLookupLabelDialog> createState() =>
      _HotStampingLookupLabelDialogState();
}

class _HotStampingLookupLabelDialogState
    extends State<HotStampingLookupLabelDialog> {
  ...
  void _toggleRow(HotStampingProductionInputViewModel vm, int index,
  ...
  void _selectAllNew(HotStampingProductionInputViewModel vm,
  ...
  Widget build(BuildContext context) {
    return Consumer<HotStampingProductionInputViewModel>(
      builder: (context, vm, _) {
        ...
        final namaJenis =
        sample == null ? prefixType.displayName : 'Furniture WIP';
  ...
  // ✅ PCS Input Dialog (similar to WeightInputDialog)
