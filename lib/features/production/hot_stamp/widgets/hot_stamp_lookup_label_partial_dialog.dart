// lib/features/production/hot_stamping/widgets/hot_stamping_lookup_label_partial_dialog.dart
...
class HotStampingLookupLabelPartialDialog extends StatefulWidget {
  final String noProduksi;
  final String selectedMode;

  const HotStampingLookupLabelPartialDialog({
    super.key,
  ...
  @override
  State<HotStampingLookupLabelPartialDialog> createState() =>
      _HotStampingLookupLabelPartialDialogState();
}

class _HotStampingLookupLabelPartialDialogState
    extends State<HotStampingLookupLabelPartialDialog> {
  int? _selectedIndex;
  int? _editedPcs; // ✅ Edit PCS instead of weight
  ...
  void _commitSelection(HotStampingProductionInputViewModel vm,
    ...
    // ✅ Set partial flag and edited pcs
    if (_editedPcs != null) {
      row['isPartial'] = true;
      row['IsPartial'] = true;
      row['pcs'] = _editedPcs;
