// lib/features/shared/hot_stamp_production/widgets/hot_stamp_production_action_bar.dart
...
class HotStampProductionActionBar extends StatefulWidget {
  ...
  const HotStampProductionActionBar({
    super.key,
  ...
  @override
  State<HotStampProductionActionBar> createState() =>
      _HotStampProductionActionBarState();
}

class _HotStampProductionActionBarState
    extends State<HotStampProductionActionBar> {
            ...
            builder: (context, c) {
              ...
              return Row(
                children: [
                  ...
                  Tooltip(
                    message: canCreate
                        ? 'Buat Produksi Hot Stamp Baru'
                        : 'Anda tidak memiliki izin untuk membuat produksi hot stamp',
