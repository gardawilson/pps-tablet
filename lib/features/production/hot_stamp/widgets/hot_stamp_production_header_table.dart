...
class HotStampProductionHeaderTable extends StatelessWidget {
  ...
  final ValueChanged<HotStampProduction> onRowTap;
  final void Function(HotStampProduction row, Offset globalPosition)
  onRowLongPress;

  const HotStampProductionHeaderTable({
    super.key,
  ...
  Widget build(BuildContext context) {
    return Consumer<HotStampProductionViewModel>(
      builder: (context, vm, _) {
        return AtlasPagedDataTable<HotStampProduction>(
  ...
  List<AtlasTableColumn<HotStampProduction>> _buildColumns() {
    return [
      AtlasTableColumn<HotStampProduction>(
        title: 'NO. PRODUKSI',
