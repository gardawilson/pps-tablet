...
const _kRejectAccent = Color(0xFF00796B);
const _kRejectBorder = Color(0xFFE2E6EA);

class HotStampRejectOutputFormDialog extends StatefulWidget {
  const HotStampRejectOutputFormDialog({
    super.key,
  ...
  @override
  State<HotStampRejectOutputFormDialog> createState() =>
      _HotStampRejectOutputFormDialogState();
}

class _HotStampRejectOutputFormDialogState
    extends State<HotStampRejectOutputFormDialog> {
          ...
          TextFormField(
            ...
            decoration: InputDecoration(
              ...
              focusedBorder: OutlineInputBorder(
                borderRadius: BorderRadius.circular(9),
                borderSide: const BorderSide(color: _kRejectAccent, width: 1.5),
              ),
