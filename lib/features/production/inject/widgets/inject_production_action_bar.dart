...
class InjectProductionActionBar extends StatefulWidget {
  final TextEditingController controller;
  final ValueChanged<String> onSearchChanged; // debounced contains
  final VoidCallback onClear;
  final VoidCallback onAddPressed;
  final Duration debounce;

  const InjectProductionActionBar({
    super.key,
  ...
  @override
  State<InjectProductionActionBar> createState() =>
      _InjectProductionActionBarState();
}

class _InjectProductionActionBarState extends State<InjectProductionActionBar> {
            ...
            builder: (context, c) {
              ...
              return Row(
                children: [
                  ...
                  Tooltip(
                    message: canCreate
                        ? 'Buat Produksi Inject Baru'
                        : 'Anda tidak memiliki izin untuk membuat produksi inject',
                    waitDuration: const Duration(milliseconds: 400),
                    child: FilledButton.icon(
                      onPressed: canCreate ? widget.onAddPressed : null,
                      icon: const Icon(Icons.add),
                      label: const Text('Tambah Produksi Inject'),
                          ...
                          Expanded(
                            child: TextField(
                              ...
                              decoration: InputDecoration(
                                hintText: 'Cari NoProduksi Inject (contains)…',
                                hintStyle:
