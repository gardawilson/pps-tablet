...
class KeyFittingInputs {
  ...
  factory KeyFittingInputs.fromJson(Map<String, dynamic> j) {
  ...
  // Empty factory
  factory KeyFittingInputs.empty() {
    return KeyFittingInputs(
      furnitureWip: [],
      cabinetMaterial: [],
      summary: {},
