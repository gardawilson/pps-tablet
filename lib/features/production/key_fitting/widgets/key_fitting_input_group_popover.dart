          ...
          child: SizedBox(
            ...
            child: Column(
              ...
              children: [
                ...
                // BODY
                Flexible(
                  child: Consumer<KeyFittingProductionInputViewModel>(
                ...
                if (widget.summaryBuilder != null)
                  Consumer<KeyFittingProductionInputViewModel>(
                    builder: (context, vm, _) {
...
class _GroupTooltipAnchorTileState extends State<GroupTooltipAnchorTile> {
  ...
  Future<void> _handleDeleteAllTemp(KeyFittingProductionInputViewModel vm) async {
