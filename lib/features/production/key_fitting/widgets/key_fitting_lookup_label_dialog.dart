...
class KeyFittingLookupLabelDialog extends StatefulWidget {
  final String noProduksi;
  final String selectedMode;
  final Set<int>? preDisabledIndices;

  const KeyFittingLookupLabelDialog({
    super.key,
  ...
  @override
  State<KeyFittingLookupLabelDialog> createState() =>
      _KeyFittingLookupLabelDialogState();
}

class _KeyFittingLookupLabelDialogState
    extends State<KeyFittingLookupLabelDialog> {
    ...
    for (final i in _localPickedIndices) {
      if (i < result.data.length) {
        ...
        if (_editedPcs.containsKey(i)) {
          ...
          // ✅ pastikan dianggap partial kalau ada edit pcs
          row['isPartial'] = true;
          row['IsPartial'] = true;
        }
                  ...
                  child: Row(
                    children: [
                      Container(
                        ...
                        child: const Icon(
                          Icons.vpn_key, // ✅ key fitting vibe
                          size: 28,
                          color: Colors.white,
                        ),
                      ),
