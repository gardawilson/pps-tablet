// lib/features/shared/key_fitting_production/widgets/key_fitting_production_action_bar.dart
...
class KeyFittingProductionActionBar extends StatefulWidget {
  ...
  const KeyFittingProductionActionBar({
    super.key,
  ...
  @override
  State<KeyFittingProductionActionBar> createState() =>
      _KeyFittingProductionActionBarState();
}

class _KeyFittingProductionActionBarState
    extends State<KeyFittingProductionActionBar> {
            ...
            builder: (context, c) {
              ...
              return Row(
                children: [
                  ...
                  Tooltip(
                    message: canCreate
                        ? 'Buat Produksi Pasang Kunci Baru'
                        : 'Anda tidak memiliki izin untuk membuat produksi pasang kunci',
