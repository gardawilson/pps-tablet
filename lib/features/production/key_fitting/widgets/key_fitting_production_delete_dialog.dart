// lib/features/shared/key_fitting_production/widgets/key_fitting_production_delete_dialog.dart
...
class KeyFittingProductionDeleteDialog extends StatefulWidget {
  ...
  const KeyFittingProductionDeleteDialog({
    super.key,
  ...
  @override
  State<KeyFittingProductionDeleteDialog> createState() =>
      _KeyFittingProductionDeleteDialogState();
}

class _KeyFittingProductionDeleteDialogState
    extends State<KeyFittingProductionDeleteDialog> {
  bool _agree = false;
      ...
      content: Column(
        ...
        children: [
          ...
          CheckboxListTile(
            ...
            title: Text(
              'Saya mengerti dan ingin menghapus produksi pasang kunci ini.',
...
class _InfoRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Row(
      ...
      children: [
        SizedBox(
          width: 96, // sedikit lebih lebar karena label "NoPasangKunci"
          child: Text(
            label,
            style: TextStyle(
