// lib/features/shared/key_fitting_production/widgets/key_fitting_production_form_dialog.dart
...
class _KeyFittingProductionFormDialogState
  ...
  // kind overlap untuk endpoint overlap (KEY FITTING)
    ...
    try {
      if (isEdit) {
        ...
        result = await prodVm.createProduksi(
          ...
          idMesin: mesinId,
          idOperator: operatorId,
          jamKerja: jamKerja ?? 0, // kalau mau wajib, default 0; atau buat validator
          shift: _selectedShift!,
          hourStart: hourStartSql,
          hourEnd: hourEndSql,
          hourMeter: hourMeter,
  ...
  Widget _buildHeader() {
    return Row(
      children: [
        ...
        Text(
          isEdit ? 'Edit Produksi Pasang Kunci' : 'Tambah Produksi Pasang Kunci',
          ...
          child: Column(
            ...
            children: [
              ...
              AppTextField(
                ...
                label: 'No. Pasang Kunci',
                icon: Icons.label,
                readOnly: true,
                hintText: 'BI.XXXXXXXXXX',
              ),
              ...
              MesinDropdown(
                idBagianMesin: 10, // ✅ TODO: sesuaikan ID bagian untuk PASANG KUNCI
                preselectId: widget.header?.idMesin,
                label: 'Mesin Pasang Kunci',
                hint: 'Pilih mesin',
