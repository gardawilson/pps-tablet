...
class KeyFittingProductionHeaderTable extends StatelessWidget {
  ...
  final ValueChanged<KeyFittingProduction> onRowTap;
  final void Function(KeyFittingProduction row, Offset globalPosition)
  onRowLongPress;

  const KeyFittingProductionHeaderTable({
    super.key,
  ...
  Widget build(BuildContext context) {
    return Consumer<KeyFittingProductionViewModel>(
      builder: (context, vm, _) {
        return AtlasPagedDataTable<KeyFittingProduction>(
  ...
  List<AtlasTableColumn<KeyFittingProduction>> _buildColumns() {
    return [
      AtlasTableColumn<KeyFittingProduction>(
        title: 'NO. PRODUKSI',
