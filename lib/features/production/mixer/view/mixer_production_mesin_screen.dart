...
import '../../shared/models/broker_stok_item.dart';
import '../../shared/models/broker_stok_label.dart';
import '../../shared/models/stok_bahan_baku_item.dart';
import '../../shared/repository/broker_stok_repository.dart';
...
class _MixerProductionMesinScreenState
  ...
  final _stokRepo = StokBahanBakuPakaiRepository();
  final _brokerStokRepo = BrokerStokRepository();
  ...
  // ── Stok Item: chip kategori (Bahan Baku / Broker) ─────────────────────────
