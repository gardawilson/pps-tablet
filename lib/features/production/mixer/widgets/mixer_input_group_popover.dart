// lib/features/production/mixer/widgets/mixer_input_group_popover.dart
...
bool _hasPartialTempForLabel(
  ...
  return hasBrokerPart || hasBbPart || hasGilinganPart || hasMixerPart;
}
          ...
          child: SizedBox(
            ...
            child: Column(
              ...
              children: [
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Builder(
                          builder: (_) {
                            final vm =
                            context.read<MixerProductionInputViewModel>();
                ...
                // =======================================================
                Flexible(
                  child: Consumer<MixerProductionInputViewModel>(
                ...
                if (widget.summaryBuilder != null)
                  Consumer<MixerProductionInputViewModel>(
                    builder: (context, vm, _) {
...
class _GroupTooltipAnchorTileState extends State<GroupTooltipAnchorTile> {
  ...
  Future<void> _handleDeleteAllTemp(
      MixerProductionInputViewModel vm) async {
