// lib/features/production/mixer/widgets/mixer_lookup_label_dialog.dart
...
class MixerLookupLabelDialog extends StatefulWidget {
  final String noProduksi;
  final String selectedMode;
  final Set<int>? preDisabledIndices;

  const MixerLookupLabelDialog({
    super.key,
  ...
  @override
  State<MixerLookupLabelDialog> createState() => _MixerLookupLabelDialogState();
}

class _MixerLookupLabelDialogState extends State<MixerLookupLabelDialog> {
  ...
  void _toggleRow(MixerProductionInputViewModel vm, int index, Map<String, dynamic> row) {
  ...
  void _selectAllNew(MixerProductionInputViewModel vm, ProductionLabelLookupResult result) {
    setState(() {
      _localPickedIndices.clear();
      for (int i = 0; i < result.data.length; i++) {
        if (!_isDisabled(i)) {
  ...
  void _commitSelection(MixerProductionInputViewModel vm, ProductionLabelLookupResult result) {
