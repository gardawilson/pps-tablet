// lib/features/shared/mixer_production/widgets/mixer_production_delete_dialog.dart
...
class MixerProductionDeleteDialog extends StatefulWidget {
  ...
  @override
  State<MixerProductionDeleteDialog> createState() =>
      _MixerProductionDeleteDialogState();
}

class _MixerProductionDeleteDialogState
    extends State<MixerProductionDeleteDialog> {
  bool _agree = false;
      ...
      content: Column(
        ...
        children: [
          ...
          CheckboxListTile(
            ...
            title: Text(
              'Saya mengerti dan ingin menghapus produksi mixer ini.',
