// lib/features/production/mixer/widgets/mixer_production_row_popover.dart
...
class MixerProductionRowPopover extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final canEdit = perm.can('produksi_mixer:update');
    final canDelete = perm.can('produksi_mixer:delete');
                ...
                child: Row(
                  children: [
                    Container(
                      ...
                      child: const Icon(
                        Icons.blender_outlined, // ✅ Mixer icon
                        color: Colors.white,
                        size: 20,
                      ),
                    ),
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          // ✅ Additional info: Jam Kerja
                          const SizedBox(height: 2),
                          Text(
                            '${row.jamKerja} jam kerja',
                            style: TextStyle(
                              fontSize: 11,
