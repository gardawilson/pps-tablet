...
class MixerProduksiList extends StatelessWidget {
  const MixerProduksiList({
    super.key,
    required this.items,
  ...
  final List<MixerProduction> items;
  final bool isLoading;
  final bool isFetchingMore;
  final ScrollController scrollController;
  final Future<void> Function(MixerProduction) onTap;
  final Future<void> Function(MixerProduction) onEdit;
  final Future<void> Function(MixerProduction) onDelete;
  final Future<void> Function(MixerProduction) onInput;
...
class _MixerProduksiRow extends StatelessWidget {
  const _MixerProduksiRow({
    required this.row,
    required this.onTap,
    required this.onEdit,
    required this.onDelete,
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        if ((row.outputJenisNama ?? '').isNotEmpty) ...[
