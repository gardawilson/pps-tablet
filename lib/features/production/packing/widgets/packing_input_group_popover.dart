          ...
          child: SizedBox(
            ...
            child: Column(
              ...
              children: [
                ...
                // BODY
                Flexible(
                  child: Consumer<PackingProductionInputViewModel>(
                ...
                if (widget.summaryBuilder != null)
                  Consumer<PackingProductionInputViewModel>(
                    builder: (context, vm, _) {
...
class _GroupTooltipAnchorTileState extends State<GroupTooltipAnchorTile> {
  ...
  Future<void> _handleDeleteAllTemp(PackingProductionInputViewModel vm) async {
