// lib/features/production/packing/widgets/packing_lookup_label_partial_dialog.dart
...
// ✅ packing inputs model exports shared item models (FurnitureWipItem, CabinetMaterialItem)
...
class PackingLookupLabelPartialDialog extends StatefulWidget {
  final String noPacking;     // ✅ ganti kalau di packing tetap noProduksi, rename saja
  final String selectedMode;

  const PackingLookupLabelPartialDialog({
    super.key,
  ...
  @override
  State<PackingLookupLabelPartialDialog> createState() =>
      _PackingLookupLabelPartialDialogState();
}

class _PackingLookupLabelPartialDialogState
    extends State<PackingLookupLabelPartialDialog> {
  int? _selectedIndex;
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      ...
      // ✅ refresh lookup based on the first item label code (same as spanner)
                  ...
                  child: Row(
                    children: [
                      Container(
                        ...
                        child: const Icon(Icons.inventory_2, size: 28, color: Colors.white),
                      ),
