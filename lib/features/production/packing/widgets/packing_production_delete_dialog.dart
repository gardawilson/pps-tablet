// lib/features/shared/packing_production/widgets/packing_production_delete_dialog.dart
...
class PackingProductionDeleteDialog extends StatefulWidget {
  ...
  const PackingProductionDeleteDialog({
    super.key,
  ...
  @override
  State<PackingProductionDeleteDialog> createState() =>
      _PackingProductionDeleteDialogState();
}

class _PackingProductionDeleteDialogState
    extends State<PackingProductionDeleteDialog> {
  bool _agree = false;
      ...
      content: Column(
        ...
        children: [
          ...
          CheckboxListTile(
            ...
            title: Text(
              'Saya mengerti dan ingin menghapus produksi packing ini.',
...
class _InfoRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Row(
      ...
      children: [
        SizedBox(
          width: 96, // cukup untuk "NoPacking"
          child: Text(
            label,
            style: TextStyle(
