...
class PackingProductionOutputFormDialog extends StatelessWidget {
  final String noPacking;
  final DateTime? tglProduksi;
  final int? outputJenisId;
  final String? namaJenis;

  const PackingProductionOutputFormDialog({
    super.key,
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (_) => PackingViewModel(repository: PackingRepository(api: ApiClient())),
      child: _PackingOutputFormBody(
        noPacking: noPacking,
...
class _PackingOutputFormBody extends StatefulWidget {
  final String noPacking;
  final DateTime? tglProduksi;
  final int? outputJenisId;
  final String? namaJenis;

  const _PackingOutputFormBody({
    required this.noPacking,
    this.tglProduksi,
    this.outputJenisId,
    this.namaJenis,
  ...
  @override
  State<_PackingOutputFormBody> createState() => _PackingOutputFormBodyState();
}

class _PackingOutputFormBodyState extends State<_PackingOutputFormBody> {
  ...
  Future<void> _save() async {
    ...
    try {
      ...
      await vm.createFromForm(
        idBJ: widget.outputJenisId,
        dateCreate: widget.tglProduksi ?? DateTime.now(),
        pcs: pcs,
        mode: PackingInputMode.packing,
        packingCode: widget.noPacking,
