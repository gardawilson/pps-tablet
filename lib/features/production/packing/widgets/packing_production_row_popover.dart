// lib/features/shared/key_fitting_production/widgets/spanner_production_row_popover.dart

import 'package:flutter/material.dart';
import 'package:flutter/services.dart';
import 'package:pps_tablet/features/production/packing/model/packing_production_model.dart';
import 'package:provider/provider.dart';

import '../../../../core/view_model/permission_view_model.dart';

class PackingProductionRowPopover extends StatelessWidget {
  final PackingProduction row;
  ...
  const PackingProductionRowPopover({
    super.key,
    required this.row,
  ...
  Future<void> _copyOnly(BuildContext context) async {
    await Clipboard.setData(ClipboardData(text: row.noPacking));
    final m = ScaffoldMessenger.maybeOf(context);
    m?.hideCurrentSnackBar();
    m?.showSnackBar(
      SnackBar(
        content: Text('noPacking "${row.noPacking}" disalin'),
  ...
  Widget build(BuildContext context) {
    ...
    final canEdit = perm.can('packing:update') && !row.isLocked;
    final canDelete = perm.can('packing:delete') && !row.isLocked;
