// lib/features/shared/return_production/widgets/return_production_action_bar.dart
import 'dart:async';
...
class ReturnProductionActionBar extends StatefulWidget {
  ...
  const ReturnProductionActionBar({
    super.key,
  ...
  @override
  State<ReturnProductionActionBar> createState() =>
      _ReturnProductionActionBarState();
}

class _ReturnProductionActionBarState extends State<ReturnProductionActionBar> {
  ...
  Widget build(BuildContext context) {
    ...
    // ✅ TODO: replace with your real permission key
              ...
              return Row(
                children: [
                  ...
                  Tooltip(
                    message: canCreate
                        ? 'Buat Return Baru'
                        : 'Anda tidak memiliki izin untuk membuat Return',
                    ...
                    child: FilledButton.icon(
                      ...
                      style: FilledButton.styleFrom(
                        backgroundColor:
                        canCreate ? Colors.indigo : Colors.grey.shade400,
                          ...
                          Expanded(
                            child: TextField(
                              ...
                              decoration: InputDecoration(
                                hintText:
                                'Cari NoRetur / Invoice / Pembeli / NoBJSortir (contains)…',
                                hintStyle:
