...
class ProductionRejectOutputFormDialog extends StatefulWidget {
  const ProductionRejectOutputFormDialog({
    super.key,
  ...
  @override
  State<ProductionRejectOutputFormDialog> createState() =>
      _ProductionRejectOutputFormDialogState();
}

class _ProductionRejectOutputFormDialogState
    extends State<ProductionRejectOutputFormDialog> {
                ...
                child: Column(
                  ...
                  children: [
                    RejectTypeDropdown(
                      ...
                      validator: (value) =>
                          value == null ? 'Pilih jenis reject' : null,
                    ),
