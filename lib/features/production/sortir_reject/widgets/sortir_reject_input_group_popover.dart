// lib/features/production/sortir_reject/widgets/sortir_reject_input_group_popover.dart
  ...
  Future<void> _confirmBulkDelete() async {
    ...
    final confirmed = await showDialog<bool>(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content:
        Text('Yakin ingin menghapus $count item yang sudah dipilih?'),
        actions: [
          TextButton(
          ...
          child: SizedBox(
            ...
            child: Column(
              ...
              children: [
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Builder(
                          builder: (_) {
                            final vm =
                            context.read<SortirRejectInputViewModel>();
                ...
                // BODY
                Flexible(
                  child: Consumer<SortirRejectInputViewModel>(
                ...
                if (widget.summaryBuilder != null)
                  Consumer<SortirRejectInputViewModel>(
                    builder: (context, vm, _) {
                  ...
                  child: Row(
                    children: _selectionMode && canDeleteExisting
                      ...
                      FilledButton.icon(
                        ...
                        label:
                        Text('Hapus (${_selectedIndices.length})'),
        ...
        children: [
          ...columns.asMap().entries.map((entry) {
            ...
            return Expanded(
              ...
              child: Padding(
                padding:
                EdgeInsets.only(right: index < columns.length - 1 ? 8 : 0),
                child: Text(
                  value,
                  style: TextStyle(
                    fontSize: 13,
...
class _GroupTooltipAnchorTileState extends State<GroupTooltipAnchorTile> {
  ...
  Future<void> _handleDeleteAllTemp(SortirRejectInputViewModel vm) async {
