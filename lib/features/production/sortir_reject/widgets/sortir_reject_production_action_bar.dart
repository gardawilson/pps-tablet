...
class SortirRejectProductionActionBar extends StatefulWidget {
  ...
  const SortirRejectProductionActionBar({
    super.key,
  ...
  @override
  State<SortirRejectProductionActionBar> createState() =>
      _SortirRejectProductionActionBarState();
}

class _SortirRejectProductionActionBarState
    extends State<SortirRejectProductionActionBar> {
            ...
            builder: (context, c) {
              ...
              return Row(
                children: [
                  ...
                  Tooltip(
                    message: canCreate
                        ? 'Buat Sortir Reject Baru'
                        : 'Anda tidak memiliki izin untuk membuat Sortir Reject',
                    waitDuration: const Duration(milliseconds: 400),
                    child: FilledButton.icon(
                      onPressed: canCreate ? widget.onAddPressed : null,
                      icon: const Icon(Icons.add),
                      label: const Text('Tambah Sortir Reject'),
                      style: FilledButton.styleFrom(
                        backgroundColor:
                        canCreate ? Colors.teal : Colors.grey.shade400,
                          ...
                          Expanded(
                            child: TextField(
                              ...
                              decoration: InputDecoration(
                                hintText: 'Cari NoBJSortir (contains)…',
                                hintStyle:
