...
import '../widgets/spanner_input_group_popover.dart';
...
class _SpannerProductionInputScreenState extends State<SpannerProductionInputScreen> {
  ...
  Widget build(BuildContext context) {
    return Consumer<SpannerProductionInputViewModel>(
      builder: (context, vm, _) {
        ...
        // ✅ adjust permission key to your system (spanner delete)
        ...
        return WillPopScope(
          ...
          child: Scaffold(
            appBar: AppBar(
              title: Text('Spanner Inputs • ${widget.noProduksi}'),
              leading: IconButton(
                                ...
                                builder: (context) {
                                  ...
                                  return CabinetMaterialCard(
                                    ...
                                    onAdd: locked
                                        ...
                                        : () {
                                      final vm = context
                                          .read<SpannerProductionInputViewModel>();

                                      showDialog(
                                        context: context,
                                        builder: (_) => AddCabinetMaterialDialog(
                                          idWarehouse: 5, // ✅ change if spanner uses different warehouse
                                          loadMaterials: ({
