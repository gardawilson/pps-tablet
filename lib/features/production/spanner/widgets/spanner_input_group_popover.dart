// lib/features/production/key_fitting/widgets/key_fitting_input_group_popover.dart

import 'package:flutter/material.dart';
import 'package:provider/provider.dart';

import '../view_model/spanner_production_input_view_model.dart';
          ...
          child: SizedBox(
            ...
            child: Column(
              ...
              children: [
                ...
                // BODY
                Flexible(
                  child: Consumer<SpannerProductionInputViewModel>(
                ...
                if (widget.summaryBuilder != null)
                  Consumer<SpannerProductionInputViewModel>(
                    builder: (context, vm, _) {
...
class _GroupTooltipAnchorTileState extends State<GroupTooltipAnchorTile> {
  ...
  Future<void> _handleDeleteAllTemp(SpannerProductionInputViewModel vm) async {
