...
class SpannerLookupLabelPartialDialog extends StatefulWidget {
  final String noProduksi;
  final String selectedMode;

  const SpannerLookupLabelPartialDialog({
    super.key,
  ...
  @override
  State<SpannerLookupLabelPartialDialog> createState() =>
      _SpannerLookupLabelPartialDialogState();
}

class _SpannerLookupLabelPartialDialogState
    extends State<SpannerLookupLabelPartialDialog> {
  int? _selectedIndex;
