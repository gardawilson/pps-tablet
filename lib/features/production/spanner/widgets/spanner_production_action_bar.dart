// lib/features/shared/spanner_production/widgets/spanner_production_action_bar.dart
...
class SpannerProductionActionBar extends StatefulWidget {
  ...
  const SpannerProductionActionBar({
    super.key,
  ...
  @override
  State<SpannerProductionActionBar> createState() =>
            ...
            builder: (context, c) {
              ...
              return Row(
                children: [
                  ...
                  Tooltip(
                    message: canCreate
                        ? 'Buat Produksi Spanner Baru'
                        : 'Anda tidak memiliki izin untuk membuat produksi spanner',
                    waitDuration: const Duration(milliseconds: 400),
                    child: FilledButton.icon(
                      onPressed: canCreate ? widget.onAddPressed : null,
                      icon: const Icon(Icons.add),
                      label: const Text('Tambah Produksi Spanner'),
