// lib/features/shared/spanner_production/widgets/spanner_production_delete_dialog.dart
...
class SpannerProductionDeleteDialog extends StatefulWidget {
  ...
  const SpannerProductionDeleteDialog({
    super.key,
  ...
  @override
  State<SpannerProductionDeleteDialog> createState() =>
      _SpannerProductionDeleteDialogState();
}

class _SpannerProductionDeleteDialogState
    extends State<SpannerProductionDeleteDialog> {
  bool _agree = false;
      ...
      content: Column(
        ...
        children: [
          ...
          CheckboxListTile(
            ...
            title: Text(
              'Saya mengerti dan ingin menghapus produksi spanner ini.',
...
class _InfoRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Row(
      ...
      children: [
        SizedBox(
          width: 96, // cukup untuk "NoSpanner"
          child: Text(
            label,
            style: TextStyle(
