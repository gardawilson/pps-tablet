...
class SpannerProductionOutputFormDialog extends StatelessWidget {
  final String noProduksi;
  final DateTime? tglProduksi;
  final int? outputJenisId;
  final String? namaJenis;

  const SpannerProductionOutputFormDialog({
    super.key,
...
class _SpannerOutputFormBody extends StatefulWidget {
  final String noProduksi;
  final DateTime? tglProduksi;
  final int? outputJenisId;
  final String? namaJenis;

  const _SpannerOutputFormBody({
    required this.noProduksi,
    this.tglProduksi,
    this.outputJenisId,
    this.namaJenis,
  ...
  @override
  State<_SpannerOutputFormBody> createState() => _SpannerOutputFormBodyState();
}

class _SpannerOutputFormBodyState extends State<_SpannerOutputFormBody> {
  ...
  Future<void> _save() async {
    ...
    try {
      ...
      await vm.createFromForm(
        ...
        blok: null,
        idLokasi: null,
        mode: FurnitureWipInputMode.spanner,
        spannerCode: widget.noProduksi,
      ...
      child: Row(
        children: [
          Container(
            ...
            child: const Icon(Icons.build_outlined, color: _kAccent, size: 17),
          ),
          const SizedBox(width: 10),
          const Text(
            'Tambah Output Spanner',
            style: TextStyle(
              fontSize: 14,
