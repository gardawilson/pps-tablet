// =============================
// lib/features/production/washing/widgets/washing_input_group_popover.dart
// Updated: Batch delete + Summary Total Berat
// =============================
...
bool _hasPartialTempForLabel(
  ...
  return hasBbPart || hasGilinganPart;
}
          ...
          child: SizedBox(
            ...
            child: Column(
              ...
              children: [
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Builder(
                          builder: (_) {
                            final vm = context
                                .read<WashingProductionInputViewModel>();
                ...
                // =======================================================
                Flexible(
                  child: Consumer<WashingProductionInputViewModel>(
                ...
                if (widget.summaryBuilder != null)
                  Consumer<WashingProductionInputViewModel>(
                    builder: (context, vm, _) {
...
class _GroupTooltipAnchorTileState extends State<GroupTooltipAnchorTile> {
          ...
          children: [
            ...
            CompositedTransformFollower(
              ...
              child: InputsGroupTooltip(
                ...
                summaryBuilder: widget.summaryBuilder, // ✅ PASS
  ...
  Future<void> _handleDeleteAllTemp(
      WashingProductionInputViewModel vm) async {
