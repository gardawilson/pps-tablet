...
class WashingProductionHeaderTable extends StatelessWidget {
  ...
  final ValueChanged<WashingProduction> onRowTap;
  final void Function(WashingProduction row, Offset globalPosition)
  onRowLongPress;

  const WashingProductionHeaderTable({
    super.key,
  ...
  Widget build(BuildContext context) {
    return Consumer<WashingProductionViewModel>(
      builder: (context, vm, _) {
        return AtlasPagedDataTable<WashingProduction>(
  ...
  List<AtlasTableColumn<WashingProduction>> _buildColumns() {
    return [
      AtlasTableColumn<WashingProduction>(
        title: 'NO. PRODUKSI',
